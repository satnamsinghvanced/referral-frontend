...
const Sidebar = ({ isMiniSidebarOpen, toggleSidebar, onCloseSidebar }) => {
  ...
  const navigationRoutes = [
    ...
    { name: "Projects", icon: HiOutlineClipboardList, href: "/projects" },
    { name: "Payments", icon: HiOutlineCurrencyDollar, href: "/payments" },
    ...
    <>
      ...
      >
        ...
        >
            ...
            {navigationRoutes.map((item, index) => {
              ...
              return (
                <li key={index}>
                  ...
                  >
                    <span
                      className={`flex items-center justify-center sm:w-7 w-6 ${
          ...
          {/* bottom items */}
          <ul
            className={`flex flex-col gap-2 text-gray-900 dark:text-white ${
              !isMiniSidebarOpen ? "ml-[-4.8px]" : ""
            }`}
          >
