...
import { LEAD_PRIORITIES, LEAD_STATUSES } from "../../../consts/lead-tracking";
          ...
          <>
            ...
            <ModalBody>
              <Tabs
                ...
                classNames={{
                  tabList:
                    "gap-8 w-full relative rounded-none p-0 border-b border-divider overflow-x-auto overflow-y-hidden",
                      ...
                      <div className="p-6 border border-divider rounded-2xl space-y-6 bg-content1/50 dark:bg-content1/20">
                        ...
                        <div className="space-y-3 mt-6">
                          <Button
                            ...
                            className="justify-start font-medium text-gray-700 dark:text-foreground/80"
                          >
                            Call via Twilio
                          </Button>
                          <Button
                        ...
                        <div className="flex flex-wrap gap-2">
                          {lead.treatments?.map((t: string, i: number) => (
                            <Chip
                              ...
                              variant="flat"
                              size="sm"
                              className="bg-sky-50 dark:bg-sky-900/40 text-sky-600 dark:text-sky-400 font-bold px-3"
                            >
                              {t}
                            </Chip>
                          ))}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
                    <div className="p-6 border border-divider rounded-2xl space-y-6 bg-content1/50 dark:bg-content1/20">
                      ...
                      <div className="space-y-2">
                        ...
                        <Chip
                          variant="flat"
                          className="bg-gray-50 dark:bg-white/5 border border-divider font-bold px-4 text-foreground"
                        >
                          {lead.source}
                        </Chip>
                      </div>
                            ...
                            {lead.tags?.length > 0 ? (
                              lead.tags.map((tag: string, i: number) => (
                                <Chip
                                  ...
                                  size="sm"
                                  variant="flat"
                                  className="bg-sky-50 dark:bg-sky-900/40 text-sky-600 dark:text-sky-400 font-bold"
                                  startContent={
