...
import { FiClock, FiPhoneIncoming, FiPhoneOutgoing, FiPlay } from "react-icons/fi";
...
export default function CallRecordCard({ record, onPlayClick }: { record: CallRecord; onPlayClick: () => void }) {
