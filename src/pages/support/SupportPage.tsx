      ...
      items: [
        {
          ...
          answer:
            "You can update your payment method in the Billing section of your account settings. Go to Settings → Billing → Payment Methods to add or update your card information.",
        },
        {
        ...
        },
        {
          ...
          answer:
            'You can cancel from your account settings. Go to Settings → Billing → Subscription and click "Cancel Subscription". Your access will continue until the end of your billing period.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          answer:
            "Our platform works on modern browsers (Chrome 90+, Firefox 88+, Safari 14+). For mobile access, use our iOS or Android app available in respective app stores.",
        },
        {
          question: "How do I reset my password?",
          answer:
            'Click "Forgot Password" on the login page. We\'ll send a reset link to your email address. The link expires in 1 hour for security.',
        },
        {
          question: "Why am I experiencing slow performance?",
          answer:
            "This could be due to internet connection, browser cache, or system maintenance. Try clearing your browser cache or check our status page for ongoing issues.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          answer:
            "Account admins can add team members from the Team Management section. Go to Settings → Team → Invite Members to send invitations.",
        },
        {
          question: "Can I transfer my account to someone else?",
          answer:
            "Yes, account transfers can be arranged. Contact our support team with both parties' information and we'll assist with the transfer process.",
        },
      ],
    },
  ];
        ...
        {activeTab === "resources" && (
          <div>
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Documentation and guides to help you get the most out of our
                platform
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-red-700">
                  For critical system outages or urgent technical issues that
