          ...
          <CardBody className="p-6">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Your orthodontic consultation request has been received
                successfully.
              </p>
            </div>
          </CardBody>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  You'll receive a confirmation email within 24 hours with your
                  appointment details.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Our team will call you within 1-2 business days to confirm
        ...
        <Card className="mt-6 bg-amber-50 border-amber-200">
          <CardBody className="p-4">
            <p className="text-sm text-amber-800 text-center">
              💡 <strong>Remember:</strong> Please bring your insurance card and
              valid photo ID to your first appointment. If you need to
