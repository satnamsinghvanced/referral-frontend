...
interface BulkImportSegmentsModalProps {
  isOpen: boolean;
  onClose: () => void;
}
...
const BulkImportSegmentsModal = ({
  ...
  const handleDownloadTemplate = () => {
    ...
    const dummyRow = [
      "VIP Partners",
      "Top referring partners in our network",
      "referralPartners",
      "last30Days",
      "Tulsa, OK",
      "",
    ...
    a.href = url;
    a.download = "audience_segment_import_template.csv";
    a.click();
            ...
            <ModalHeader className="flex flex-col gap-1 px-4">
              <div className="flex items-center gap-2">
                ...
                <h4 className="text-base font-medium dark:text-white">
                  Bulk Import Audience Segments
                </h4>
              </div>
              <p className="text-xs text-gray-500 font-normal dark:text-foreground/60">
                Import multiple audience segments at once from a CSV
            ...
            <ModalBody className="py-0 px-4 gap-3">
              ...
              <div className="border border-blue-200 bg-blue-50/50 dark:bg-blue-900/10 dark:border-blue-500/30 rounded-xl p-4">
                ...
                <ol className="text-xs text-gray-600 dark:text-foreground/60 space-y-1.5 list-decimal list-inside pl-1">
                  ...
                  <li>Use exact header names (name, type, etc.)</li>
                  <li>
                    Fill in segment data following the backend allowed values
                  </li>
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-gray-500 dark:text-foreground/40 md:max-w-[150px]">
                      Get our CSV template with allowed values and examples
                    </p>
                  </div>
                </div>
                <Button
...
export default BulkImportSegmentsModal;
