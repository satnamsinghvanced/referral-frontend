...
const PartnerNetworkCard = ({ partner, actions }: PartnerNetworkCardProps) => {
  return (
    <div className="border border-foreground/10 rounded-lg p-4 bg-content1 space-y-5 md:space-y-3.5 shadow-none">
      <div className="flex items-center gap-2.5 max-sm:flex-col max-sm:items-start max-sm:gap-4">
        ...
        <div className="font-medium text-sm w-full h-full flex flex-col justify-center gap-1.5">
          <div className="flex items-center justify-between gap-2 max-sm:flex-col-reverse max-sm:gap-2 max-sm:items-start max-sm:mb-0.5">
      ...
      <div className="flex items-center justify-between h-full w-full gap-5 text-sm max-md:flex-col max-md:items-start max-md:gap-4">
