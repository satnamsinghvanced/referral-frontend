...
const SignupPricingView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#070C18] text-slate-900 dark:text-slate-100 flex flex-col items-center py-10 px-4 sm:px-6">
      ...
      {/* Step Indicator */}
      <div className="flex items-center justify-center gap-3 sm:gap-6 mt-6 mb-8 select-none flex-wrap">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold text-slate-900 dark:text-white">Choose Plan</span>
        </div>
        <div className="w-8 sm:w-12 h-[2px] bg-slate-300 dark:bg-slate-700" />
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-slate-400">Your Details</span>
        </div>
        <div className="w-8 sm:w-12 h-[2px] bg-slate-300 dark:bg-slate-700" />
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded-full bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 flex items-center justify-center text-xs font-bold">
      ...
      {/* Pricing Cards Grid or Empty State */}
      {plans.length === 0 ? (
        ...
        {plans.map((plan) => {
          ...
          // Use monthlyFeatures or yearlyFeatures based on selected billingCycle
